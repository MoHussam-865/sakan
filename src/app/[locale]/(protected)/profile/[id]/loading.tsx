export default function ProfileDetailLoading() {
  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-8 animate-pulse">
      {/* Back link skeleton */}
      <div className="h-4 w-28 bg-zinc-100 rounded mb-8" />

      {/* Header skeleton */}
      <div className="flex items-center gap-4 mb-8">
        <div className="w-16 h-16 rounded-full bg-zinc-100 shrink-0" />
      ...
      {/* About me skeleton */}
      <div className="mb-8 pb-8 border-b border-zinc-200/60 space-y-2">
      ...
      <div className="space-y-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="flex items-start gap-4">
            <div className="h-4 w-32 bg-zinc-100 rounded shrink-0" />
